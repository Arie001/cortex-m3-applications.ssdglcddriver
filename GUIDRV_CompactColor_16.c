...
Purpose     : Driver for the following display controllers:
              ...
              - Solomon SSD1289, SSD2119, SSD1298
              - Toshiba JBT6K71
...
#define SIM_ReadMA1C0     SIM_CompactColor_16_ReadA1C0
...
#define SIM_ReadMA1C0_16  SIM_CompactColor_16_ReadA1C0_16
...
*/
  ...
  #if   (LCD_CONTROLLER == 66702)                               /* Solomon SSD1289, Solomon SSD2119, Solomon SSD1298 */
...
#elif (LCD_CONTROLLER == 66702)    /* Solomon SSD1289, Solomon SSD2119, Solomon SSD1298 */
  /* Register definitions */
...
*/
    ...
    (LCD_CONTROLLER == 66702) || /* Solomon SSD1289, Solomon SSD2119, Solomon SSD1298 */ \
...
static U16 _ReadU16_A1(void) {
  ...
  #if LCD_USE_PARALLEL_16
    U16 Word[1 + LCD_NUM_DUMMY_READS];
    //READM_A1(Word, 1 + LCD_NUM_DUMMY_READS);  // zamieniono linia nizej - nie wiadomo czemu nie dziala.
	  LCD_X_ReadM01_16(Word, 1 + LCD_NUM_DUMMY_READS);
    return Word[LCD_NUM_DUMMY_READS];
  #else
    U16 Data;
...
*       - Solomon SSD1289, Solomon SSD2119, Solomon SSD1298
*       - Toshiba JBT6K71
*       - Ilitek ILI9320
*/
/*********************************************************************
...
static void _SendCacheRect(void) {
    ...
    pCache = _pVRam + (CACHE_OFFSET * _y0 + _x0);
  ...
  case LCD_DRAWMODE_XOR:
    do {
      if (*p & (0x80 >> Diff)) {
        ...
        SET_PIXEL_INDEX(x, y, (U16)(LCD_NUM_COLORS - 1 - Pixel));
      }
      x++;
      if (++Diff == 8) {
        Diff = 0;
...
*/
static void _NextPixel_WriteBuffer(int PixelIndex) {
  #if LCD_USE_PARALLEL_16
    *(_pBuffer++) = PixelIndex;
  #else
    U8 Byte0, Byte1;
...
*       _ReadRect
*/
#if (LCD_CONTROLLER == 66709) && (LCD_CACHE == 0) /* Novatek NT39122, Renesas R61516, Sitronix ST7628, Sitronix ST7637, Epson S1D19122 */
...
void LCD_L0_XorPixel(int x, int y) {
  ...
  LCD_L0_SetPixelIndex(x, y, (U16)(LCD_NUM_COLORS - PixelIndex - 1));
}
...
int  LCD_L0_Init(void) {
    ...
    //
    Addr      = (U32)GUI_ALLOC_GetFixedBlock(CACHE_OFFSET * LCD_VYSIZE * 2 + 1) + 1;
    if (Addr == 0) {
      while (1); // Error: No memory for cache available!
    }
    Addr &= ~1;
    _pVRam = (U16 *)Addr;
  #endif
...
void * LCD_L0_GetDevFunc(int Index) {
  ...
  case LCD_DEVFUNC_ISHW:
    return (void *)1;
  #if (LCD_CONTROLLER == 66709) && (LCD_CACHE == 0) /* Novatek NT39122, Renesas R61516, Sitronix ST7628, Sitronix ST7637 */
